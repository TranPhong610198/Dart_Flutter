...
import 'package:myfschool_flutter_fe/widgets/select_child_bottom_sheet.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (mounted) {
        if (user.role == 'ROLE_PARENTS') {
          showModalBottomSheet(
            context: context,
            isScrollControlled: true,
            backgroundColor: Colors.transparent,
            builder: (context) => SelectChildBottomSheet(parentUser: user),
          );
        } else {
